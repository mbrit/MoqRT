...
namespace Castle.DynamicProxy.Generators.Emitters
{
	...
	{
		public static IFieldInfo[] GetAllFields(this Type type)
		{
			if (type == null)
			{
			...
			while (currentType != typeof(object))
			{
				...
				var currentFields = currentType.GetFields(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static).AsIFieldInfos();
		...
		public static bool IsFinalizer(this IMethodInfo method)
		{
            return string.Equals("Finalize", method.Name) && method.GetBaseDefinition().DeclaringType == typeof(object);
		}

		public static bool IsGetType(this IMethodInfo method)
		{
			return method.DeclaringType == typeof(object) && string.Equals("GetType", method.Name, StringComparison.OrdinalIgnoreCase);
		}

		public static bool IsMemberwiseClone(this IMethodInfo method)
		{
            return method.DeclaringType == typeof(object) && string.Equals("MemberwiseClone", method.Name, StringComparison.OrdinalIgnoreCase);
		}
