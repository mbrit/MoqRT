...
namespace Castle.DynamicProxy.Generators.Emitters
{
	...
	internal class GenericUtil
	{
		...
		private static Type AdjustConstraintToNewGenericParameters(
			Type constraint, IMethodInfo methodToCopyGenericsFrom, Type[] originalGenericParameters,
		...
		private static Type[] AdjustGenericConstraints(IMethodInfo methodToCopyGenericsFrom,
		                                               GenericTypeParameterBuilder[] newGenericParameters,
