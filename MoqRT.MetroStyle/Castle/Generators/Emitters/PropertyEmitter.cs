...
namespace Castle.DynamicProxy.Generators.Emitters
{
	...
	public class PropertyEmitter : IMemberEmitter
	{
			...
			else
			{
				...
				var newDefinedProperty = (DefineProperty_Clr_2_0_SP1)
				                         Delegate.CreateDelegate(typeof(DefineProperty_Clr_2_0_SP1),
				                                                 ...
				                                                 TypeBuilderMethods.DefineProperty.AsMethodInfo());
		...
		public MethodEmitter CreateGetMethod(string name, MethodAttributes attrs, IMethodInfo methodToOverride,
		...
		public MethodEmitter CreateGetMethod(string name, MethodAttributes attributes, IMethodInfo methodToOverride)
		{
			return CreateGetMethod(name, attributes, methodToOverride, TypeExtender.EmptyTypes);
		}

		public MethodEmitter CreateSetMethod(string name, MethodAttributes attrs, IMethodInfo methodToOverride,
		                                     params Type[] parameters)
		{
			if (setMethod != null)
			{
		...
		public MethodEmitter CreateSetMethod(string name, MethodAttributes attributes, IMethodInfo methodToOverride)
		{
