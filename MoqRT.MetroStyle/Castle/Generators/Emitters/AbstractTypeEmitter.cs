...
namespace Castle.DynamicProxy.Generators.Emitters
{
	...
	public abstract class AbstractTypeEmitter
	{
		...
		public void CopyGenericParametersFromMethod(IMethodInfo methodToCopyGenericsFrom)
		{
			// big sanity check
		...
		public MethodEmitter CreateMethod(string name, IMethodInfo methodToUseAsATemplate)
		{
			return CreateMethod(name, defaultAttributes, methodToUseAsATemplate);
		}

		public MethodEmitter CreateMethod(string name, MethodAttributes attributes, IMethodInfo methodToUseAsATemplate)
		{
