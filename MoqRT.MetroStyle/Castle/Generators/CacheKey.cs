...
namespace Castle.DynamicProxy.Generators
{
	...
	public class CacheKey
	{
		...
		public CacheKey(IMemberInfo target, Type type, Type[] interfaces, ProxyGenerationOptions options)
		...
		{
			private IMemberInfo Member { get; set; }
			private Type Type { get; set; }

			internal MemberWrapper(IMemberInfo member)
			{
				this.Member = member;
			}
