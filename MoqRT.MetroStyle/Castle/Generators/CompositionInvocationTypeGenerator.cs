...
namespace Castle.DynamicProxy.Generators
{
	...
	public class CompositionInvocationTypeGenerator : InvocationTypeGenerator
	{
		...
		public CompositionInvocationTypeGenerator(Type target, MetaMethod method, IMethodInfo callback, bool canChangeTarget,
		...
		{
			return new FieldReference(InvocationMethods.Target.AsFieldInfo());
		}
