...
namespace Castle.DynamicProxy.Generators
{
	...
	public class MethodSignatureComparer : IEqualityComparer<IMethodInfo>
	{
		public static readonly MethodSignatureComparer Instance = new MethodSignatureComparer();

		public bool EqualGenericParameters(IMethodInfo x, IMethodInfo y)
		{
		...
		public bool EqualParameters(IMethodInfo x, IMethodInfo y)
		{
		...
		private bool EqualNames(IMethodInfo x, IMethodInfo y)
		{
