...
namespace Castle.DynamicProxy.Tokens
{
	...
	/// <summary>
	///   Holds <see cref = "IMethodInfo" /> objects representing methods of <see cref = "SerializationInfo" /> class.
	/// </summary>
