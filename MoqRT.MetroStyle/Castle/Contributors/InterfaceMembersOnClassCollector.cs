...
namespace Castle.DynamicProxy.Contributors
{
	...
	public class InterfaceMembersOnClassCollector : MembersCollector
	{
		...
		private IMethodInfo GetMethodOnTarget(IMethodInfo method)
		{
			...
			return map.TargetMethods[index].AsIMethodInfo();
		}

		private bool IsVirtuallyImplementedInterfaceMethod(IMethodInfo method)
		{
