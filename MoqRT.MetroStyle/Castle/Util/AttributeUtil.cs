...
//                                                out IPropertyInfo[] properties, out object[] propertyValues,
//                                                out IFieldInfo[] fields, out object[] fieldValues)
//        {
//            var propertyList = new List<IPropertyInfo>();
//            var propertyValuesList = new List<object>();
//            var fieldList = new List<IFieldInfo>();
...
//                        propertyList.Add(argument.MemberInfo as IPropertyInfo);
//                        propertyValuesList.Add(argument.TypedValue.Value);
//                        break;
//                    case MemberTypes.Field:
//                        fieldList.Add(argument.MemberInfo as IFieldInfo);
