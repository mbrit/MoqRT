...
namespace Castle.DynamicProxy.Serialization
{
	...
	public class RemotableInvocation : MarshalByRefObject, IInvocation, ISerializable
	{
		...
		public IMethodInfo GetConcreteMethod()
		{
		...
		///   <see cref = "IMethodInfo" /> on the target class
		/// </summary>
		public IMethodInfo MethodInvocationTarget
		{
			get { return parent.MethodInvocationTarget; }
		}

		public IMethodInfo GetConcreteMethodInvocationTarget()
		{
