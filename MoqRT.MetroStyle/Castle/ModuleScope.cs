...
//		public static readonly String DEFAULT_FILE_NAME = "CastleDynProxy2.dll";
        public static readonly String DEFAULT_FILE_NAME = "MoqRT.Baked.dll";
...
#else
                assemblyBuilder = new AssemblyBuilder(StrongNamedModule.Assembly());
#endif
...
#else
                assemblyBuilder = new AssemblyBuilder(WeakNamedModule.Assembly());
#endif
