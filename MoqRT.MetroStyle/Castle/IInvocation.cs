...
namespace Castle.DynamicProxy
{
	...
	public interface IInvocation
	{
		...
		/// <summary>
		///   Gets the <see cref = "IMethodInfo" /> representing the method being invoked on the proxy.
		/// </summary>
		/// <value>The <see cref = "IMethodInfo" /> representing the method being invoked.</value>
		MethodInfo Method { get; }

		/// <summary>
		///   For interface proxies, this will point to the <see cref = "IMethodInfo" /> on the target class.
		/// </summary>
