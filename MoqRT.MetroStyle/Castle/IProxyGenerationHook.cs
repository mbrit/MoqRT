...
namespace Castle.DynamicProxy
{
	...
	public interface IProxyGenerationHook
	{
		...
		/// </remarks>
		void NonProxyableMemberNotification(Type type, IMemberInfo memberInfo);

		/// <summary>
		///   Invoked by the generation process to determine if the specified method should be proxied.
		/// </summary>
		/// <param name = "type">The type which declares the given method.</param>
		/// <param name = "IMethodInfo">The method to inspect.</param>
		/// <returns>True if the given method should be proxied; false otherwise.</returns>
		bool ShouldInterceptMethod(Type type, IMethodInfo IMethodInfo);
	}
}